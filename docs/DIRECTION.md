...
**No glow in orbit, at any intensity.** No bloom, no lens flare, no chromatic aberration, no holographic panels, no emissive UI. Quiet Vector has zero bloom and that is precisely why it does not read as sci-fi. A hard rule of none is easier to hold than a budget of a little. (Indoors is the owner-decided exception: rebuilt rooms author their glow under `docs/INTERIORS.md` - painted halos and baked spill, never a postprocessing pass.)
